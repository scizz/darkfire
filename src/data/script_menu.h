...
static const struct MenuAction MultichoiceList_ChooseStone[] =
{
    {gText_ThunderStone},
    {gText_FireStone},
    {gText_WaterStone},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_TV_GUIDE]                   = MULTICHOICE(MultichoiceList_TVGuide),
    ...
    [MULTI_CHOOSE_STONE]               = MULTICHOICE(MultichoiceList_ChooseStone),
