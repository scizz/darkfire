const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_AQUA_GRUNT_M] = TRAINER_PIC_SUBO_M,
    ...
    [FACILITY_CLASS_AQUA_GRUNT_F] = TRAINER_PIC_SUBO_F,
    ...
    [FACILITY_CLASS_KOJIRO] = TRAINER_PIC_KOJIRO,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_KOJIRO] = TRAINER_CLASS_RIVAL,
