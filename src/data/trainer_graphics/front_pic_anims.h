...
static const union AnimCmd *const sAnims_Kojiro[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_SuboM[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_SuboF[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_DazRegular[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Gill[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_KOJIRO] = sAnims_Kojiro,
    [TRAINER_PIC_SUBO_M] = sAnims_SuboM,
    [TRAINER_PIC_SUBO_F] = sAnims_SuboF,
    [TRAINER_PIC_DAZ_REGULAR] = sAnims_DazRegular,
    [TRAINER_PIC_SKIER] = sAnims_Skier,
    [TRAINER_PIC_RANCHER] = sAnims_Rancher,
    [TRAINER_PIC_COWGIRL] = sAnims_Cowgirl,
    [TRAINER_PIC_GILL] = sAnims_Gill,
