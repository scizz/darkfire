...
const struct Tileset gTileset_Zorya =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Zorya,
    .palettes = gTilesetPalettes_Zorya,
    .metatiles = gMetatiles_Zorya,
    .metatileAttributes = gMetatileAttributes_Zorya,
    .callback = NULL,
};

const struct Tileset gTileset_Darkspace1 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Darkspace1,
    .palettes = gTilesetPalettes_Darkspace1,
    .metatiles = gMetatiles_Darkspace1,
    .metatileAttributes = gMetatileAttributes_Darkspace1,
    .callback = NULL,
};

const struct Tileset gTileset_Darkspace2 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Darkspace2,
    .palettes = gTilesetPalettes_Darkspace2,
    .metatiles = gMetatiles_Darkspace2,
...
const struct Tileset gTileset_Rindo =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Rindo,
    .palettes = gTilesetPalettes_Rindo,
    .metatiles = gMetatiles_Rindo,
    .metatileAttributes = gMetatileAttributes_Rindo,
    .callback = NULL,
};

const struct Tileset gTileset_PinapIslands =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PinapIslands,
    .palettes = gTilesetPalettes_PinapIslands,
    .metatiles = gMetatiles_PinapIslands,
...
const struct Tileset gTileset_SeaRoute =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SeaRoute,
    .palettes = gTilesetPalettes_SeaRoute,
    .metatiles = gMetatiles_SeaRoute,
...
const struct Tileset gTileset_MtTwilight =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_MtTwilight,
    .palettes = gTilesetPalettes_MtTwilight,
    .metatiles = gMetatiles_MtTwilight,
...
const struct Tileset gTileset_ColossusTemple =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_ColossusTemple,
    .palettes = gTilesetPalettes_ColossusTemple,
    .metatiles = gMetatiles_ColossusTemple,
