...
#define MAP_GROUP_TOWNS_AND_ROUTES MAP_GROUP(CHANDRA_VILLAGE)
#define MAP_GROUP_DUNGEONS MAP_GROUP(ANHEIM_FOREST)
#define MAP_GROUP_SPECIAL_AREA MAP_GROUP(ARCTIC_BAY)
