...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}You're out of\nSafari Balls! Game over!\p");
...
static const u8 sText_PkmnBrokeFree[] = _("The Pokémon broke free!");
static const u8 sText_ItAppearedCaught[] = _("The Pokémon broke the ball!");
static const u8 sText_AarghAlmostHadIt[] = _("You almost had it!");
static const u8 sText_ShootSoClose[] = _("No way!\nIt was so close!");
