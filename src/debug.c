...
static void DebugAction_Util_Fly(u8 taskId)
{
    ...
    FlagSet(FLAG_VISITED_SUNRISE_TOWN);
    FlagSet(FLAG_VISITED_UNION_CITY);
    FlagSet(FLAG_VISITED_GREENDALE_VILLAGE);
    FlagSet(FLAG_VISITED_ANHEIM_TOWN);
    FlagSet(FLAG_VISITED_FORTREE_CITY);
    FlagSet(FLAG_VISITED_LAVERIA_CITY);
    FlagSet(FLAG_VISITED_PINLEAF_TOWN);
...
static void DebugAction_Flags_ToggleFlyFlags(u8 taskId)
{
    ...
    FlagToggle(FLAG_VISITED_SUNRISE_TOWN);
    FlagToggle(FLAG_VISITED_UNION_CITY);
    FlagToggle(FLAG_VISITED_GREENDALE_VILLAGE);
    FlagToggle(FLAG_VISITED_ANHEIM_TOWN);
    FlagToggle(FLAG_VISITED_FORTREE_CITY);
    FlagToggle(FLAG_VISITED_LAVERIA_CITY);
    FlagToggle(FLAG_VISITED_PINLEAF_TOWN);
...
#define SOUND_LIST_BGM \
    ...
    X(MUS_CHANDRA_VILLAGE) \
    X(MUS_ROUTE_1) \
    X(MUS_TRAINER_BATTLE) \
    X(MUS_ABANDONED_MUSEUM) \
    X(MUS_ANHEIM_FOREST) \
    X(MUS_CAVE) \
    X(MUS_ICE_PALACE) \
    X(MUS_SNOWDRIFT_FOREST) \
    X(MUS_TAMAROK_PEAK) \
    X(MUS_TEMPLE_OF_KINGS) \
    X(MUS_SUBO_CONTROL) \
    X(MUS_SUBO_THEME) \
    X(MUS_ROUTE_3_4) \
    X(MUS_ROUTE_5_6) \
