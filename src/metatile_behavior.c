...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_FOREST_TALL_GRASS]               = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
    [MB_LONG_GRASS]                      = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
    [MB_HAY_LONG_GRASS]                  = TILE_FLAG_UNUSED, //| TILE_FLAG_HAS_ENCOUNTERS,
    ...
    [MB_NORTHSOUTH_JUMP]                 = TILE_FLAG_UNUSED,
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_FOREST_TALL_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsForestTallGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_FOREST_TALL_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsHayLongGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_HAY_LONG_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsSandPath(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SAND_PATH)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsRunningDisallowed(u8 metatileBehavior)
{
    if (metatileBehavior == MB_NO_RUNNING
     ...
     || metatileBehavior == MB_HAY_LONG_GRASS
...
{
    if (metatileBehavior == MB_TALL_GRASS
     || metatileBehavior == MB_FOREST_TALL_GRASS
     || metatileBehavior == MB_LONG_GRASS
     || metatileBehavior == MB_HAY_LONG_GRASS
