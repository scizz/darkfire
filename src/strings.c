...
const u8 gText_DexHoennTitle[] = _("Tenjo Dex");
const u8 gText_DexNatTitle[] = _("Tenjo Dex");
...
const u8 gText_DexSearchColorBrown[] = _("Brow");
...
const u8 gText_DexHoennDescription[] = _("Tenjo region's Pokédex");
const u8 gText_DexNatDescription[] = _("Tenjo region's Pokédex");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pProf. Hawthorne's Pokédex rating!\pProf. Hawthorne: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Prof. Hawthorne is in trouble!\nRelease a Pokémon and rescue him!");
...
const u8 gText_DadsAdvice[] = _("Huh?\nYou can't do that here.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Challenge[] = _("Challange");
...
const u8 gText_ThunderStone[] = _("{FONT_SMALL}Thunderstone");
const u8 gText_WaterStone[] = _("{FONT_SMALL}Water Stone");
const u8 gText_FireStone[] = _("{FONT_SMALL}Fire Stone");
const u8 gText_LeafStone[] = _("{FONT_SMALL}Leaf Stone");
const u8 gText_MoonStone[] = _("{FONT_SMALL}Moon Stone");
const u8 gText_SunStone[] = _("{FONT_SMALL}Sun Stone");
const u8 gText_DawnStone[] = _("{FONT_SMALL}Sun Stone");
const u8 gText_DuskStone[] = _("{FONT_SMALL}Moon Stone");
const u8 gText_LaveriaIsland[] = _("Laveria Island");
const u8 gText_NorthstarCity[] = _("Northstar City");
const u8 gText_LaveriaCity[] = _("Laveria City");
const u8 gText_WaterwayCity[] = _("Waterway City");
...
const u8 gText_LanettesPC[] = _("Ernie's PC");
const u8 gText_PlayersPC[] = _("Items PC");
...
const u8 gText_SuperRank[] = _("Supser Rank");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Tenjo region.");
...
const u8 gText_NoRibbonWinners[] = _("There are no Ribbons winners.");
...
const u8 gText_LaprasDoll128BP[] = _("Larpas Doll{CLEAR_TO 0x58}128BP");
...
const u8 gText_DreamEater24BP[] = _("Drem Eater{CLEAR_TO 0x4E}24BP");
...
const u8 gText_DexHoenn[] = _("Tenjo");
const u8 gText_DexNational[] = _("Tenjo");
...
const u8 gEasyChatGroupName_Misc[] = _("Mis.");
...
const u8 gText_ContestLady_Vinny[] = _("Vinnt");
...
const u8 gText_TVGuide[] = _("TV Guide");
const u8 gText_HowToUse[] = _("How to Use");
const u8 gText_SearchMode[] = _("Search Mode");
const u8 gText_DetectorMode[] = _("Detector Mode");
const u8 gText_Chaining[] = _("Chaining");
