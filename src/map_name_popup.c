...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_ANHEIM_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAVERIA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HIGHWIND_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NORTHSTAR_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_PINLEAF_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WATERWAY_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MAYHEM_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MOONSPRING_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ZORYA_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DRIFTSTREAM_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MIRANIA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_THYMESGROVE_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TWILIGHT_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PORT_BALINA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WEST_DISTRICT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BATTLE_DISTRICT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PORT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OUTSKIRTS] = MAPPOPUP_THEME_WOOD,
