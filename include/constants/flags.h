...
#define FLAG_WARPED_TO_CHANDRA    0x25 // Warped to Chandra Village for Beta 3
...
#define FLAG_NORTHSTAR_TOURNAMENT_SUBO       0x54
#define FLAG_NORTHSTAR_SUBO_TAKEOVER         0x55
...
#define FLAG_NORTHSTAR_TOURNAMENT_ROSE_4F    0x68
...
#define FLAG_NORTHSTAR_TOURNAMENT_SUBO_1F    0x71
...
#define FLAG_HIDE_ROUTE_1_TRUCK              0xE9 // Darkfire Flag
...
#define FLAG_HIDDEN_ITEM_CHANDRA_VILLAGE_PLAYERS_HOUSE_2F_POTION (FLAG_HIDDEN_ITEMS_START + 0x11) // Darkfire Flag
...
#define FLAG_HIDDEN_ITEM_ROUTE_4_REPEL                       (FLAG_HIDDEN_ITEMS_START + 0x2C)
#define FLAG_HIDDEN_ITEM_ROUTE_4_PARALYZE_HEAL               (FLAG_HIDDEN_ITEMS_START + 0x3E)
#define FLAG_HIDDEN_ITEM_ROUTE_4_SUPER_POTION                (FLAG_HIDDEN_ITEMS_START + 0x25)
#define FLAG_HIDDEN_ITEM_ROUTE_4_FULL_HEAL                   (FLAG_HIDDEN_ITEMS_START + 0x55)
#define FLAG_HIDDEN_ITEM_HIGHWIND_VILLAGE_SHEENY_SEED        (FLAG_HIDDEN_ITEMS_START + 0x58) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_ROUTE_5_ETHER                       (FLAG_HIDDEN_ITEMS_START + 0x59) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_ROUTE_6_GREAT_BALL                  (FLAG_HIDDEN_ITEMS_START + 0x6F) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_ROUTE_6_X_SPEED                     (FLAG_HIDDEN_ITEMS_START + 0x3F) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_ROUTE_6_POKE_BALL                   (FLAG_HIDDEN_ITEMS_START + 0x2E) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_NORTHSTAR_CITY_ULTRA_BALL           (FLAG_HIDDEN_ITEMS_START + 0x2F) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_NORTHSTAR_CITY_FULL_HEAL            (FLAG_HIDDEN_ITEMS_START + 0x56) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_NORTHSTAR_CITY_SNOWBALL             (FLAG_HIDDEN_ITEMS_START + 0x32) // DARKFIRE FLAG
#define FLAG_HIDDEN_ITEM_ROUTE_6_PARALYZE_HEAL               (FLAG_HIDDEN_ITEMS_START + 0x34) // DARKFIRE FLAG
...
#define FLAG_UNION_CITY_RATTATA             0x26E
...
#define FLAG_HIDE_ROUTE_2_ZIGZAGOON                                 0x2EE // Darkfire flag
...
#define FLAG_HIDE_RUSTURF_TUNNEL_ROCK_1                             0x3A3 // Darkfire Flag
#define FLAG_HIDE_RUSTURF_TUNNEL_ROCK_2                             0x3A4 // Darkfire Flag
...
#define FLAG_ITEM_ROUTE_10_REPEL                                    0x406 // Darkfire Flag
...
#define FLAG_ITEM_ROCKFALL_CAVE_INTERLINK_SUPER_POTION              0x452
...
#define FLAG_ITEM_ROUTE_4_POKE_BALL                                 0x45B // Darkfire Flag
...
#define FLAG_ITEM_LAVERIA_CITY_NUGGET                               0x46E
...
#define FLAG_HIDE_DAZ_2_MUDKIP                                      0x479 // Darkfire Flag
#define FLAG_ITEM_ROUTE_116_POTION                                  0x47A
#define FLAG_ITEM_PINLEAF_TOWN_ELIXIR                               0x47B
...
#define FLAG_ITEM_ROUTE_3_LUXURY_BALL                               0x488 // Darkfire Flag
...
#define FLAG_RECEIVED_ROUTE_9_AWAKENING                             0x493 // Darkfire Flag
#define FLAG_HIDE_ROCKFALL_CAVE_B1F_LARVITAR                        0x494 // Darkfire Flag
...
// Darkfire Trades
#define FLAG_COMPLETE_TRADE_MAGIKARP                                0x4EE // Highwind Village House 2
...
#define FLAG_VISITED_GREENDALE_VILLAGE              (SYSTEM_FLAGS + 0x12)
#define FLAG_VISITED_ANHEIM_TOWN                    (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_LAVERIA_CITY                   (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_PINLEAF_TOWN                   (SYSTEM_FLAGS + 0x15)

#define FLAG_VISITED_LAVARIDGE_TOWN                 (SYSTEM_FLAGS + 0x16)
#define FLAG_VISITED_FALLARBOR_TOWN                 (SYSTEM_FLAGS + 0x17)
#define FLAG_VISITED_VERDANTURF_TOWN                (SYSTEM_FLAGS + 0x18)
#define FLAG_VISITED_PACIFIDLOG_TOWN                (SYSTEM_FLAGS + 0x19)
...
#define FLAG_SYS_TELESCOPE_USE                      (SYSTEM_FLAGS + 0x83)

#define FLAG_RECEIVED_POKEDEX_FROM_BIRCH            (SYSTEM_FLAGS + 0x84)

#define FLAG_PPULSE_QUESTS_UNLOCKED                 (SYSTEM_FLAGS + 0x85)
#define FLAG_PPULSE_SEEKER_UNLOCKED                 (SYSTEM_FLAGS + 0x86)
