...
#define FLAG_VISITED_LAVARIDGE_TOWN                 (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_FALLARBOR_TOWN                 (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_VERDANTURF_TOWN                (SYSTEM_FLAGS + 0x15)
#define FLAG_VISITED_PACIFIDLOG_TOWN                (SYSTEM_FLAGS + 0x16)
#define FLAG_VISITED_OLDALE_TOWN                    (SYSTEM_FLAGS + 0x17)
#define FLAG_VISITED_DEWFORD_TOWN                   (SYSTEM_FLAGS + 0x18)
