...
#define VAR_LAST_REPEL_LURE_USED    0x4052       // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        FLAG_I_VS_SEEKER_CHARGING      // If this flag is assigned, the Vs Seeker will functionlity will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working.
