...
#define MAPSEC_MAYHEM_CITY                  0xDE
#define MAPSEC_WATERWAY_CITY                0xDF
#define MAPSEC_MOONSPRING_CITY              0xE0
#define MAPSEC_ZORYA_VILLAGE                0xE1
#define MAPSEC_DRIFTSTREAM_TOWN             0xE2
#define MAPSEC_MIRANIA_TOWN                 0xE3
#define MAPSEC_THYMESGROVE_CITY             0xE4
#define MAPSEC_TWILIGHT_VILLAGE             0xE5
#define MAPSEC_PORT_BALINA                  0xE6
#define MAPSEC_WEST_DISTRICT                0xE7
#define MAPSEC_BATTLE_DISTRICT              0xE8
#define MAPSEC_PORT                         0xE9
#define MAPSEC_OUTSKIRTS                    0xEA
#define MAPSEC_ANHEIM_FOREST                0xEB
#define MAPSEC_ROCKFALL_CAVE                0xEC
#define MAPSEC_TAMAROK_TUNNELS              0xED
#define MAPSEC_ARCTIC_BAY                   0xEF
#define MAPSEC_SOUL_PEAK                    0xF0
#define MAPSEC_CHARRED_SUMMIT               0xF1
