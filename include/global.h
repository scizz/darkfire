...
struct SaveBlock1
{
    ...
    /*0x490*/ u32 money;
    /*0x494*/ u16 coins;
    /*0x496*/ u16 registeredItemCompat; // registered for use with SELECT button
    ...
    /*0x9C8*/ u16 trainerRematchStepCounter;  // MAX_REMATCH_ENTRIES decreased from vanilla's 100 to 92
